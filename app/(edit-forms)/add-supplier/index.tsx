...
function BasicInfoCard({ control, focusedField, setFocusedField, t }: SubcomponentProps) {
  return (
...
function NotesCard({ control, focusedField, setFocusedField, t }: SubcomponentProps) {
  return (
    <View className="bg-paper-50 rounded-2xl shadow-paper border border-ink-100 p-4 mt-3 mb-4">
      <View className="mb-4">
        <StyledText
