...
export default function AddSupplier() {
  ...
  const { insertSupplierMutation, getAllSuppliersQuery } = useSuppliers();
    ...
    <SafeAreaView className="flex-1 bg-background" edges={['top', 'bottom']}>
          ...
          <View className="bg-paper-50 rounded-2xl border border-ink-100 p-4 shadow-paper mt-3 mb-4 space-y-3">
            <View className="flex-row items-center justify-between">
              <View>
                ...
                >
                  Select existing products to link with this supplier (
              ...
              {products.length === 0 ? (
                productsQuery.isLoading ? (
                  <View className="py-6 items-center">
                    ...
                    <StyledText
                      variant="medium"
                      className="text-ink-400 text-xs mt-2"
                    >
                      Loading products...
                    </StyledText>
                  </View>
                    ...
                    return (
                      ...
                      >
                        <View className="flex-1 mr-2">
                          <StyledText
                            variant="semibold"
                            className="text-ink-900 text-md"
                          >
                            {product.name}
                          </StyledText>
                          <StyledText
      ...
      <View className="p-4 bg-paper-50 border-t border-ink-100 shadow-paper">
        <Pressable
          ...
          accessibilityRole="button"
          accessibilityLabel="Save supplier"
          accessibilityState={{
            disabled: !isValid,
        ...
        <Controller
          ...
          rules={{
            ...
            validate: {
              notBlank: (val) =>
                val.trim().length > 0 ||
                t('supplierNameBlank', 'Supplier name cannot be blank'),
              uniqueName: (val) => {
            ...
            <View>
              <View className="relative justify-center">
                ...
                <TextInput
                  ...
                  returnKeyType="next"
                  accessibilityLabel={t('labelName', 'Supplier Name')}
          ...
          render={({ field: { onChange, onBlur, value } }) => (
            <View className="relative justify-center">
              ...
              <TextInput
                ...
                autoCapitalize="none"
                returnKeyType="next"
                accessibilityLabel={t('labelContact', 'Contact Info')}
                className={`text-ink-900 text-base border rounded-xl pl-11 pr-11 py-3.5 font-stack-sans ${
