...
export default function EditProduct() {
	...
	const onSubmit = async (data: EditProductForm) => {
		try {
			...
			const costPriceValue = data.costPerPiece ? parseFloat(data.costPerPiece) : undefined;
			...
			>
				...
				>
					...
					<View className="mb-4">
						...
						>
							The price you paid when buying this product. Used to calculate profit.
						</StyledText>
					</View>
					{/* Price */}
					<View className="mb-4">
						...
						{/* Profit Preview */}
						{formValues.costPerPiece && formValues.price && parseFloat(formValues.costPerPiece) > 0 && parseFloat(formValues.price) > 0 && (
							<View className="bg-green-50 rounded-lg p-3 mt-2 flex-row items-center justify-between">
								...
								<View className="items-end">
									...
									<StyledText variant="extrabold" className="text-green-700 text-lg">
										{(((parseFloat(formValues.price) - parseFloat(formValues.costPerPiece)) / parseFloat(formValues.costPerPiece)) * 100).toFixed(1)}%
									</StyledText>
								</View>
							</View>
						)}
