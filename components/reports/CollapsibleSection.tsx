...
const TONE_NUMBER_COLOR: Record<NonNullable<CollapsibleSectionProps['tone']>, string> = {
...
const TONE_ICON_BG: Record<NonNullable<CollapsibleSectionProps['tone']>, string> = {
...
export function CollapsibleSection({
	...
	const handlePress = () => {
		// Smooth cross-platform animation when expanding/collapsing.
