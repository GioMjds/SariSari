  ...
  return (
    <View className="mb-3">
      <View className="flex-row items-center bg-paper-50 border border-ink-200 rounded-xl px-3 py-2.5 focus-within:border-persimmon-500">
        ...
        <StyledText variant="medium" className="text-ink-700 text-sm ml-2 mr-1">
          {noun}
        </StyledText>
...
function ClearButton({ onClear }: { onClear: () => void }) {
  return (
    <Pressable
      ...
      className="press-scale ml-1 w-8 h-8 items-center justify-center rounded-full bg-paper-200"
    >
